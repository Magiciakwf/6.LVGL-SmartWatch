...
/* Optional application pages are disabled for the core architecture. */
#define CALENDAR_PAGE_EN        0
#define COMPUTER_PAGE_EN        0
#define TIMER_PAGE_EN           0
#define CARD_PAGE_EN            0
#define SPROTS_PAGE_EN          0
#define HR_PAGE_EN              0
#define O2_PAGE_EN              0
#define ENVIRONMENT_PAGE_EN     0
#define COMPASS_PAGE_EN         0
#define GAME_PAGE_EN            0
#define SET_PAGE_EN             1
#define ABOUT_PAGE_EN           0
